...
ACCOUNT_PASSWORD = 'youjiaokuaidianhaoqilaiomalibeibeihongaowu6'
...
for listing in all_listings:
    ...
    try:
        ...
        if submit_button.get_attribute("data-control-name") == "continue_unify" or submit_button.get_attribute("aria-label") == "Continue to next step":
            abort_application()
